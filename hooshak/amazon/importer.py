...
class AmazonImporter:
    @classmethod
    def seek_file(cls):
        uri = settings.amazon.csv

        with open(uri, 'r') as csv_file:
            csv_reader = csv.reader(csv_file, delimiter=settings.csv.delimiter)
    ...
    def do_import(self):
        ...
        #                     print(
        #                         f'last_1000_err_percent {functools.reduce(operator.add, last_1000_err) / (len(last_1000_err) / 25 )}')
        #
        ...
        #                     print(
        #                         f'average_last_1000_err_percent {functools.reduce(operator.add, average_last_1000_err) / 40}')
        #
        #
        #                 except KeyError:
